    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='classes', to='core.Trainer', verbose_name='form trainer')),
            ],
            options={
